...
class ConfusionMatrix(object):
    ...
    def plot(self):
        ...
        # 设置x轴坐标label
        plt.xticks(range(self.num_classes), self.labels, rotation=65)
        # 设置y轴坐标label
        ...
        plt.tight_layout()
        plt.savefig('/tmp/Test9_efficientNet/ConfusionMatrix/result_EfficientNetB3/result115pth.png')
        # plt.show()
...
if __name__ == '__main__':
    ...
    # load pretrain weights
    model_weight_path = "/tmp/Test9_efficientNet/weights/B3_weights/model-First-115.pth"
    assert os.path.exists(model_weight_path), "cannot find {} file".format(model_weight_path)
    net.load_state_dict(torch.load(model_weight_path, map_location=device))
    net.to(device)

    # read class_indict
    json_label_path = '/tmp/Test9_efficientNet/ConfusionMatrix/class_indices.json'
